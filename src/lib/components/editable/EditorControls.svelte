...
<div class="sticky top-0 z-10 sm:px-4 sm:py-4">
	<div
		class="mx-auto max-w-screen-lg border-b border-t border-gray-100 bg-white bg-opacity-95 px-2 shadow backdrop-blur-sm sm:rounded-full sm:border"
	>
		<div>
			<div class="flex items-center overflow-x-auto px-1 py-3">
				{#if editorState}
					<div class="flex">
						...
						<div class="mx-3 hidden w-px bg-gray-300 sm:block" />
