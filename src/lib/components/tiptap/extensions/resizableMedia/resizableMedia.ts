//? https://github.com/sereneinserenade/tiptap-media-resize/blob/main/src/components/resizableMedia/resizableMedia.ts
...
export const ResizableMedia = Node.create<MediaOptions>({
	...
	addNodeView() {
		...
		return SvelteNodeViewRenderer(ResizableMediaNodeView);
