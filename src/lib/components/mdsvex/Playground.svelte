		...
		<div class="toggle-wrap">
			<div class="toggle">
				...
				<span class="toggle-wrapper">
					<input type="radio" name="theme" id="input" bind:group={checked} value="input" />
					<input type="radio" name="theme" id="output" bind:group={checked} value="output" />
					<span aria-hidden="true" class="toggle-background" on:click={handle_select} />
					<span aria-hidden="true" class="toggle-switcher" on:click={handle_select} />
				</span>
